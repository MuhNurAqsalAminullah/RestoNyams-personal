...
const NavbarAll = () => {
    ...
    return (
        <div className='sm:bg-[#0172FF] fixed w-full z-10 md:h-fit md:bg-[#0172FF]'>
            <div className='sm:flex sm:items-center sm:justify-between sm:px-5 sm:py-4 sm:text-white md:px-[50px] lg:[100px]'>
                <div>
                    <Link to={"/"}>
                        <h3 className='sm:text-lg sm:font-semibold md:text-2xl lg:text-3xl'>Resto<span className='font-semibold font-["Signika"] text-white'>Nyams</span></h3>
                    </Link>
                </div>
